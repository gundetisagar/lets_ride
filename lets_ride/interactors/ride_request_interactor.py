...
from lets_ride.exceptions.exceptions import InvalidToPlace, InvalidDatetime, InvalidEndDatetime, InvalidNoOfSeats, \
...
class RideRequestInteractor(ValidationMixin):
    ...
    def create_ride_request(self, ride_request_dto: RideRequestDTO):
        ...
        self.validate_no_of_seats(no_of_seats=ride_request_dto.no_of_seats)

        self.validate_luggage_quantity(luggage_quantity=ride_request_dto.luggage_quantity)
